...
TOOLS.SHOVEL = function(cid, item, fromPosition, itemEx, toPosition)
	...
	elseif(isInArray(SAND, itemEx.itemid)) then
 		if getPlayerStorageValue(cid,100004) == 1 and itemEx.uniqueid == 2104 then
		   doPlayerAddItem(cid,10225,1)
		   setPlayerStorageValue(cid,100004, 2)
		   doPlayerSendTextMessage(cid,25,"You have found a nautical map.")

		   setPlayerStorageValue(cid,100063, 17)
		end
