...
ladderpos = {x=32476, y=31904, z=6, stackpos=1}
...
if item.actionid == 11002 and item.itemid == 1945 and
...
elseif item.actionid == 11002 and item.itemid == 1946 then
doRemoveItem(getThingfromPos({x=32476, y=31904, z=6, stackpos=1}).uid, 1386)
doTransformItem(item.uid,item.itemid-1)
